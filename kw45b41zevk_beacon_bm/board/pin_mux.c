...
- options: {callFromInitBoot: 'false', prefix: BOARD_INITPINBUTTONBOOTCONFIG_, coreID: cm33, enableClock: 'true'}
- pin_list:
...
void BOARD_InitPinButtonBootConfig(void)
{
    ...
    PORT_SetPinConfig(BOARD_INITPINBUTTONCFG_SW4_PORT, BOARD_INITPINBUTTONCFG_SW4_PIN, &SW4);
}
