...
typedef enum {
    ...
    gHandoverAnchorMonitorPacketEvent_c,                /*!< Event received from Controller - Handover Anchor Monitor Packet */
    gHandoverAnchorMonitorPacketContinueEvent_c,        /*!< Event received from Controller - Handover Anchor Monitor Packet Continue */
...
typedef struct {
    ...
    union {
        ...
        handoverAnchorMonitorPacketEvent_t          handoverAnchorMonitorPacket;            /*!< Data for the gHandoverAnchorMonitorPacketEvent_c event */
        handoverAnchorMonitorPacketContinueEvent_t  handoverAnchorMonitorPacketContinue;    /*!< Data for the gHandoverAnchorMonitorPacketContinueEvent_c event */
