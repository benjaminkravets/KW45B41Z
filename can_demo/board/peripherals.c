...
- config_sets:
  - edmaCfg:
    - edma_channels:
      - enable_rx_fifo_edma_channel: 'true'
      - edma_rx_fifo_channel:
        - uid: '1734747480184'
        - eDMAn: '0'
        - eDMA_source: 'kDmaRequestCAN0'
...
flexcan_mb_transfer_t CAN0_rx_mb_transfer = {
  .frame = &FrameRx,
  .mbIdx = 0
};
flexcan_frame_t FrameTx;
flexcan_mb_transfer_t CAN0_tx_mb_transfer = {
  .frame = &FrameTx,
  .mbIdx = 1
};
edma_handle_t CAN0_eDMA_Handle;
flexcan_edma_handle_t CAN0_FLEXCAN_eDMA_Handle;
...
static void CAN0_init(void) {
  ...
  /* Set the kDmaRequestCAN0 request */
  EDMA_SetChannelMux(CAN0_EDMA_DMA_BASEADDR, CAN0_EDMA_DMA_CHANNEL, CAN0_EDMA_DMA_REQUEST);
  /* Create the eDMA CAN0_eDMA_Handle handle */
  EDMA_CreateHandle(&CAN0_eDMA_Handle, CAN0_EDMA_DMA_BASEADDR, CAN0_EDMA_DMA_CHANNEL);
  /* Create the FlexCAN eDMA handle */
  FLEXCAN_TransferCreateHandleEDMA(CAN0_PERIPHERAL, &CAN0_FLEXCAN_eDMA_Handle, NULL, NULL, &CAN0_eDMA_Handle);
}
