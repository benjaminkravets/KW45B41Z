...
- {id: MRCC.MRCC_LPUART0_CLK.outFreq, value: 32/3 MHz}
...
- {id: MRCC.MRCC_LPUART0_DIV.scale, value: '9'}
- {id: MRCC.MRCC_LPUART0_SEL.sel, value: SCG.FIRC_CLK}
...
void BOARD_BootClockRUN(void)
{
    ...
    CLOCK_SetIpSrcDiv(kCLOCK_Lpuart0, kSCG_SysClkDivBy9);
}
