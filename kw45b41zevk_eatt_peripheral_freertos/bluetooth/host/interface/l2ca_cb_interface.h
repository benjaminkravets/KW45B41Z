...
typedef struct l2caLeCbLowPeerCredits_tag
{
    deviceId_t  deviceId;
    uint16_t    cId;
} l2caLeCbLowPeerCredits_t;
...
*
* \retval       gL2caSuccess_c                  Successful callbacks
*                                               installation.
* \retval       gL2caCallbackAlreadyInstalled_c Callbacks already installed.
********************************************************************************** */
...
*
* \retval       gL2caLePsmInsufficientResources_c   No free LE_PSM registration slot
*                                                   was found.
* \retval       gL2caLePsmInvalid_c                 Invalid LE_PSM value.
* \retval       gL2caLePsmAlreadyRegistered_c       LE_PSM already registered.
* \retval       gL2caSuccess_c                      Successful LE_PSM registration.
********************************************************************************** */
...
* \param[in]    lePsm               Bluetooth SIG or Vendor LE_PSM.
*
* \retval       gL2caSuccess_c              Successful LE_PSM deregistration.
* \retval       gL2caLePsmNotRegistered_c   LE_PSM value not registered.
* \retval       gL2caInternalError_c        There are connected L2CAP channels for
*                                           the LE_PSM
*
...
*
* \retval       gL2caSuccess_c          Successful application to host message sent.
...
* \retval       gL2caSuccess_c          Successful application to host message sent.
* \retval       gBleInvalidParameter_c  Invalid Device Id.
* \retval       gBleOverflow_c          Tx queue of the device is not empty.
* \retval       gBleOutOfMemory_c       Message or packet allocation fail.
*
...
* \retval       gL2caSuccess_c          Successful application to host message sent.
* \retval       gBleOutOfMemory_c       Message allocation fail.
* \retval       gBleInvalidParameter_c  Invalid device id or invalid noOfChannels.
*
...
* \retval       gL2caSuccess_c          Successful application to host message sent.
* \retval       gBleOutOfMemory_c       Message allocation fail.
* \retval       gBleInvalidParameter_c  Invalid device id, invalid noOfChannels or
*                                       invalid aCids pointer.
*
