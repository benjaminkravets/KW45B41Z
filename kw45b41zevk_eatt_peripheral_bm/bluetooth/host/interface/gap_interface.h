...
*
********************************************************************************** */
bleResult_t Gap_PeriodicAdvReceiveEnable(uint16_t syncHandle);
...
/*!*************************************************************************************************
* \fn           bleResult_t Gap_GetConnParams(deviceId_t deviceId, uint8_t mode)
*
