...
static uint8_t adData1[2] = { UuidArray(gBleSig_AService_d) };
static uint8_t adData2[2] = { UuidArray(gBleSig_BService_d) };
...
static gapServiceSecurityRequirements_t serviceSecurity[4] = {
  {
    .requirements = {
    ...
    .serviceHandle = (uint16_t)service_A
  },
  {
    .requirements = {
        .securityModeLevel = gSecurityMode_1_Level_3_c,
  ...
  },
  {
      ...
      .serviceHandle = (uint16_t)service_B
  }
};
