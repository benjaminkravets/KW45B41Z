...
const uint8_t default_COEX_config[COEX_CONFIG_SIZE] = {
    ...
    0x00, /* rfmcGpoCoex;               rfmcGpoCoex_t 0..5 */
    ...
    0x01, /* rfna_pin_enable;           Input pin for RF_NOT_ALLOWED. coexRfNotAllowPin_t 0..5 */
    ...
    0x96, /* rf_act_extend;             RF_ACTIVE remains asserted this many microseconds after the end of TSM RX or TX sequences. Must be <=255. */
    0x64, /* rf_act_tx_advance;         RF_ACTIVE aserts this many microseconds before the end of TX warm up. If this value is > than the number of microseconds before end of TX warm  ramp up in the TSM timing sequence then an error will be returned. */
    0x59, /* rf_act_rx_advance;         RF_ACTIVE aserts this many microseconds before the RX digital is enabled. If this value is > than the number of microseconds before end of RX warm  ramp up in the TSM timing sequence then an error will be returned. */
    ...
    0x59, /* rf_stat_tx_advance;        RF_STATUS aserts this many microseconds before the end of TX warm up. Must < TX_WU=0x70. */
    //-------- coexRfPriorityConfig_t:
    0x59, /* rf_pri_tx_advance;         RF_PRIORITY aserts this many microseconds before the end of TX warm up. If this value is > than the number of microseconds before end of TX warm  ramp up in the TSM timing sequence then an error will be returned. */
    0x59, /* rf_pri_rx_advance;         RF_PRIORITY aserts this many microseconds before the RX digital is enabled. If this value is > than the number of microseconds before end of RX warm  ramp up in the TSM timing sequence then an error will be returned. */
