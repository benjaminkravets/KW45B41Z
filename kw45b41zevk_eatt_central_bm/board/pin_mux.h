...
/* Symbols to be used with GPIO driver */
#define BOARD_INITPINBUTTONCFG_SW4_GPIO GPIOA               /*!<@brief GPIO peripheral base pointer */
#define BOARD_INITPINBUTTONCFG_SW4_GPIO_PIN_MASK (1U << 4U) /*!<@brief GPIO pin mask */

/* Symbols to be used with PORT driver */
#define BOARD_INITPINBUTTONCFG_SW4_PORT PORTA               /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINBUTTONCFG_SW4_PIN 4U                   /*!<@brief PORT pin number */
#define BOARD_INITPINBUTTONCFG_SW4_PIN_MASK (1U << 4U)      /*!<@brief PORT pin mask */
                                                          /* @} */
 ...
 *
 */
void BOARD_InitPinButtonBootConfig(void);
