...
/*! @name PORTA17 (number 12), U11[2]/R173/J1[2]/J13[4]/LIN_TX/UART0_TX/TPM0_CH5
  @{ */

/* Symbols to be used with PORT driver */
#define BOARD_INITPINS_UART0_TX_PORT PORTA                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_UART0_TX_PIN 17U                   /*!<@brief PORT pin number */
#define BOARD_INITPINS_UART0_TX_PIN_MASK (1U << 17U)      /*!<@brief PORT pin mask */
                                                          /* @} */
...
/*! @name PORTA16 (number 11), U9[4]/R172/J1[1]/J13[3]/LIN_RX/UART0_RX/TPM0_CH4
  @{ */

/* Symbols to be used with PORT driver */
#define BOARD_INITPINS_UART0_RX_PORT PORTA                /*!<@brief PORT peripheral base pointer */
#define BOARD_INITPINS_UART0_RX_PIN 16U                   /*!<@brief PORT pin number */
