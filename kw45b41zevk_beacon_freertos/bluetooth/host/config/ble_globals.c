...
extern uint16_t mActiveServiceChangedCCCDHandle[gBleAppMaxActiveConnectionsGattCaching_c];
...
extern procDataStruct_t* pProcedureData[gAppMaxConnections_c * (1U + gAppEattMaxNoOfBearers_c)];
